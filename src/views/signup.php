...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1"><b>Reveal </b><b class="text-primary">Me</b></a>
    </div>
    <div class="card-body">
    <?php 
        if(!empty($error)){
    ...
    <?php } ?>
        ...
        <div class="row">
          <div class="col-8">
            <div class="icheck-primary">
                <a href="/home/signin" class="text-center">I already signed</a>
            </div>
          </div>
          <!-- /.col -->
          <div class="col-4">
      ...
      <div class="social-auth-links text-center mt-5">
        ...
        <a href="#" class="btn btn-block btn-danger mt-3">
